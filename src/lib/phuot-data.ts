...
export const OVERVIEW: OverviewRow[] = [
  ...
  { n: 2, date: "21/6 · CN", route: "Đồng Hới → Huế (ven biển Quảng Trị)", highlight: "Đặc sản Đồng Hới, hải sản Cửa Tùng, Thành cổ QT – Vĩ tuyến 17, phố đêm Huế", km: "~195", sleep: "🌙 Huế" },
...
export const GENERAL_NOTES: { label: string; text: string }[] = [
  ...
  { label: "Thời tiết tháng 6", text: "Miền Trung nắng gắt, thường 34–38°C ban ngày. Mang kem chống nắng SPF50+, mũ, ô, và bạt che kính lái (bắt buộc — xe đỗ ngoài nắng rất nóng)." },
  { label: "Bé 1 tuổi", text: "Xuất phát buổi sáng từ 8h (trừ Ngày 1 đi sớm 5h30). Nghỉ trưa dài mỗi ngày, mang địu/xe đẩy, dừng nghỉ mỗi 1,5–2h khi đi đường dài." },
  { label: "Bé lớp 2", text: "Bắt buộc mặc áo phao khi tắm biển (nhiều bãi sóng lớn, không có cứu hộ như Kỳ Xuân)." },
  { label: "Cao tốc", text: "Nên dán thẻ thu phí không dừng (ETC) và nạp sẵn tiền. Đổ đầy xăng trước các chặng dài." },
  { label: "Đặt trước", text: "Khách sạn (mùa hè cao điểm, riêng Cửa Lò dễ cháy phòng) và bàn nhà hàng đông khách. Giá vé/giờ mở cửa là mức tham khảo 2025–2026, nên kiểm tra lại sát ngày đi." },
];
...
export const DAYS: Day[] = [
  {
    ...
    slots: [
      ...
      { label: "☀️ Trưa", rows: [
        ...
        { time: "12:15", act: "Ăn trưa + nghỉ tại Nhà hàng Hải sản Bao Cấp 1994 (ngay bãi Kỳ Xuân). Ăn xong nằm võng nghỉ ~30–45 phút.", map: "Hải sản Bao Cấp 1994 Kỳ Xuân Hà Tĩnh", eat: "Hải sản tươi: ghẹ, mực, tôm, cá (~200–400k/người) · Bao Cấp 1994 – 0358571276", note: "ĐẶT BÀN TRƯỚC (T7 rất đông). Dự phòng: Dân Hường 0919973458." },
      ] },
      { label: "🌤️ Chiều", rows: [
        { time: "14:15", act: "Kỳ Xuân → Đồng Hới: qua Kỳ Anh – Đèo Ngang (cung QL1A/ven biển, cảnh đẹp). Có thể ra lại cao tốc nếu muốn nhanh.", note: "Đèo Ngang ngắn, cảnh đẹp. Bé dễ say — nghỉ giữa chặng nếu cần.", km: "~95 km" },
      ...
      { label: "🌙 Tối", rows: [
        { time: "19:00", act: "Ăn tối hải sản đặc sản Đồng Hới. Dạo bờ kè sông Nhật Lệ nếu bé còn khỏe.", eat: "Hải sản: Nhàn Bistro · Nhà hàng Hằng (tươi, đặc sản Quảng Bình)", note: "Gọi đặt bàn trước. Ngủ trước 22h để mai đỡ mệt." },
      ] },
    ],
  ...
  },
  {
    ...
    slots: [
      { label: "🌅 Sáng", rows: [
        ...
        { time: "09:30", act: "Rừng Dừa Bảy Mẫu (Cẩm Thanh): trải nghiệm thuyền thúng ~1h — bé lớp 2 rất thích.", map: "Rừng dừa Bảy Mẫu Cẩm Thanh Hội An", note: "Vé cổng ~30k; thuyền thúng 150–200k/người. Áo phao đầy đủ, bế bé 1 tuổi.", km: "~7 km" },
      ] },
      { label: "☀️ Trưa", rows: [
      ...
      { label: "🌙 Tối", rows: [
        ...
        { time: "18:30", act: "Ăn tối + ngắm Cầu Rồng, cầu Tình Yêu, tượng Cá chép hóa rồng.", map: "Cầu Rồng Đà Nẵng", eat: "Bánh tráng thịt heo Cốm Đại Lộc – 103 Trưng Nữ Vương · hải sản Bé Mặn · bún chả cá Bà Phiến", note: "Cầu Rồng phun lửa/nước chỉ tối T7–CN 21h (hôm nay T3 không có show)." },
      ] },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { label: "☀️ Trưa", rows: [
        { time: "11:15", act: "Đà Nẵng → Huế qua hầm Hải Vân (nhanh, bé đỡ say xe). Dừng Lăng Cô ăn trưa hải sản.", map: "Bãi biển Lăng Cô", eat: "Hải sản bãi biển Lăng Cô hoặc cảng Chân Mây (mẹo: KHÔNG ăn bên đầm Lập An — đắt & kém ngon hơn)", note: "Hầm Hải Vân nhanh & an toàn hơn đèo cho chiều về.", km: "~100 km" },
      ...
      { label: "🌙 Tối", rows: [
        { time: "18:00", act: "Ăn tối các món Huế chưa thử + dạo phố đêm / chợ Đông Ba buổi tối.", map: "Chợ Đông Ba Huế", eat: "Bánh khoái · nem lụi Quán Hạnh · bún thịt nướng · chè hẻm Hùng Vương", note: "Đêm cuối ở Huế — thử nốt đặc sản." },
      ] },
    ],
  ...
  },
  {
    ...
    slots: [
      { label: "🌅 Sáng", rows: [
        ...
        { time: "08:45", act: "Xuất phát Cửa Lò → Hà Nội, đi cao tốc toàn tuyến (Diễn Châu–Bãi Vọt ngược ra Nghi Sơn–QL45–Mai Sơn–Cao Bồ–Cầu Giẽ–Pháp Vân).", note: "Cao tốc nhanh & thẳng, tránh QL1A đông. T7 chiều về HN có thể đông — đi sớm." },
      ] },
      { label: "☀️ Trưa", rows: [
    ...
    hotel: "Về nhà — không cần đặt phòng.",
  },
];
...
export const FOOD: FoodCard[] = [
  ...
  { city: "Đà Nẵng", dish: "Hải sản", shops: "Bé Mặn · Bé Anh · Cua Biển", note: "Ven biển Mỹ Khê / Võ Nguyên Giáp, hải sản tươi." },
